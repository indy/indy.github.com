...
p(meta). 17 April 2008

h1. {{ page.title }}

One of the organisation's I'm volunteering for have asked me to analyse their web traffic and measure the effectiveness of mass emails they send out. Unfortunately their CMS system ignores arguments passed into URLs, grouping several separate pages to the same URL and badly skewing the statistics.
...
<pre>166869 www.foo.org.uk/content.asp?ID=42 someone@gmail.com day 38 - 15:15</pre>
...
(defun sort-hash-by-key (hash value-fn)
  (let ((l '()))
    (maphash (lambda (k v)
             ...
             hash)
    (sort l (lambda (a b)
              (< (string-to-number (car a)) (string-to-number (car b)))))))
